...
---
On Wednesday $28^{\text{th}}$ of October Mauro presented [Adversarial Variational Bayes](https://arxiv.org/pdf/1701.04722.pdf) by Mescheder et al. You can find the slides for the presentation [here](https://neuralnetworksbristol.netlify.com/Adversarial_Variational_Bayes_Mauro.pdf). The abstract is given below:
