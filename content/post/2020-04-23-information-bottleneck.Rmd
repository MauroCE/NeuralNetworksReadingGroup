...
tags:
  ...
  - deep-neural-networks
---
On Tuesday $21^{\text{st}}$ of April Mingxuan Yi talked about the topic of information bottleneck. The main references used were [Opening the black box of Deep Neural Networks via Information](https://arxiv.org/pdf/1703.00810.pdf) by Ravid Schwartz-Ziv and [Deep Learning and the Information Bottleneck Principle](https://arxiv.org/pdf/1503.02406.pdf). The abstracts are given below
...
the hidden layers to converge to such critical points



**Deep Learning and the Information Bottleneck Principle**

> — Deep Neural Networks (DNNs) are analyzed via
