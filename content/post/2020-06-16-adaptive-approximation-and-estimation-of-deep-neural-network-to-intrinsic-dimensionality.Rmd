...
On Tuesday $16^{\text{th}}$ of June Patrick Rubin-Delanchy presented [Adaptive approximation and estimation of deep neural network to intrinsic dimensionality](https://arxiv.org/abs/1907.02177). The abstract is given below.

> We prove that the performance of deep neural networks (DNNs) is mainly determined by
