...
```{r, echo=FALSE}
dates    <- seq(as.Date("2020-06-30"), as.Date("2020-07-28"), by="weeks")
names    <- c("Mark Beaumont", "Mauro Camara Escudero", "Mingxuan Yi", "Andy Wang", "Sam Tickle")
location <- rep("Fry Building 1.11", 5)
schedule <- data.frame(
  Date=dates,
  Name=names,
  Room=location
