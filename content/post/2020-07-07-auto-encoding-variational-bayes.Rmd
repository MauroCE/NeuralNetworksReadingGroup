...
On Tuesday $7^{\text{th}}$ of July, Mauro Camara Escudero presented [Auto-Encoding Variational Bayes](https://arxiv.org/pdf/1312.6114.pdf). Slides can be found [here](https://neuralnetworksbristol.netlify.com/VAE_Mauro.pdf). The abstract is given below.
